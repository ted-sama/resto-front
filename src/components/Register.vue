      ...
      <div class="p-6">
        ...
        <form @submit.prevent="register">
          <div class="mb-4">
            ...
            <input v-model="firstName" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="firstName" type="text" placeholder="Nom de famille">
          </div>
          <div class="mb-4">
            <label class="block text-gray-700 font-bold mb-2" for="lastName">Prénom</label>
            <input v-model="lastName" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="lastName" type="text" placeholder="Prénom">
          </div>
          <div class="mb-4">
          ...
          <div class="flex items-center justify-between">
            ...
            <router-link to="/login" class="ml-10 inline-block align-baseline font-bold text-sm text-gray-600 hover:text-gray-800">Déjà un compte ?<br> Se connecter</router-link>
          </div>
        </form>
