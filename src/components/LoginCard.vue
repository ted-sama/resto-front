        ...
        <div class="bg-white p-8 rounded-lg sm:shadow-lg">
          ...
          <form @submit.prevent="login" class="space-y-4">
            ...
            <div>
              <button
                type="submit"
                class="w-full bg-primary text-white p-2 rounded-lg mt-8 hover:bg-primary-dark transition duration-200 ease-in-out"
              >
                Connexion
              </button>
            </div>
          ...
          <div>
            <router-link to="/register" class="text-primary mt-4 block">
